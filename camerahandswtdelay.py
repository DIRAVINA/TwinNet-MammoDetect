...
# Variables to manage prediction display
prediction_display_time = 4 # seconds
pred_time = None
        ...
        for handLMs in hand_landmarks:
            ...
            if roi.size > 0: 
                ...
                if combined_features.shape[1] == 1764: 
                    ...
                    pred_time = time.time()  # Record the time when predictions are made

    # Display predictions if available and within the display time limit
